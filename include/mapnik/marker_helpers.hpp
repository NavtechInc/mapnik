...
struct vector_markers_dispatch : util::noncopyable
{
    ...
    void add_path(T & path)
    {
        ...
        value_bool adjust_edges = get<value_bool, keys::adjust_edges>(sym_, feature_, vars_);
        value_bool fit_marker = get<value_bool, keys::fit_marker>(sym_, feature_, vars_);
        ...
        markers_placement_params params { src_->bounding_box(), tr, spacing * scale_factor_, max_error, allow_overlap, avoid_edges, adjust_edges, fit_marker };
...
struct raster_markers_dispatch : util::noncopyable
{
    ...
    void add_path(T & path)
    {
        ...
        markers_placement_params params { bbox, marker_trans_, spacing * scale_factor_, max_error, allow_overlap, avoid_edges, adjust_edges, fit_marker };
