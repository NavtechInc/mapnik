...
namespace mapnik {
    ...
    protected:
          text_placements_combined(text_placements_ptr simple_placement, text_placements_ptr list_placement, bool reversed);
    ...
    class text_placements_reverse_combined : public text_placements_combined
    {
    public:
        text_placements_reverse_combined(text_placements_ptr simple_placement, text_placements_ptr list_placement);
    ...
    public:
        text_placement_info_combined(text_placements_combined const* parent, double scale_factor, text_placement_info_ptr simple_placement_info, text_placement_info_ptr list_placement_info, bool reversed);
        bool next() const;
    ...
    private:
        ...
        void apply_list_placement() const;
        
        bool apply_placements(text_placement_info_ptr first, text_placement_info_ptr second) const;
        void apply_placement(text_placement_info_ptr first) const;
