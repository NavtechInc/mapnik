...
public:
    ...
    /*
     using iterator = std::vector<glyph_position>::iterator;
...
struct scoped_glyph_positions_offset
{
        ...
        , marker_pos_(glyphs.marker_pos())
    {
        ...
        {
           glyphs_.set_marker(marker_info, marker_pos_ + offset, glyphs_.marker_bbox());
        }
    }
    ...
    ~scoped_glyph_positions_offset()
    {
        ...
        if (auto const& marker_info = glyphs_.get_marker())
        {
            glyphs_.set_marker(marker_info, marker_pos_, glyphs_.marker_bbox());
        }
    }
